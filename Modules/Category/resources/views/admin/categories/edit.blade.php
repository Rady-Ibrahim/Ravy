                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="number" name="menu_order" value="{{ old('menu_order', $category->menu_order) }}"
                                    class="w-full rounded-xl border border-slate-300 focus:border-slate-500 focus:ring focus:ring-slate-200 px-4 py-3 transition-all">
                            ...
                            <div class="flex items-end pb-1">
                                <label class="inline-flex items-center gap-3 cursor-pointer">
                                    ...
                                    <input type="checkbox" name="show_in_sidebar" value="1" @checked(old('show_in_sidebar', $category->show_in_sidebar))
                    ...
                    <div class="p-6 space-y-7">
                        ...
                        <div>
                            ...
                            <img id="preview-image" 
                                 ...
                                 class="mt-3 h-12 w-12 rounded-xl object-cover border border-slate-200 shadow-sm" alt="Preview">
                        </div>
                        ...
                        <div>
                            ...
                            <img id="preview-banner" 
                                 ...
                                 class="mt-3 h-12 w-20 rounded-xl object-cover border border-slate-200 shadow-sm" alt="Preview">
                        </div>
