                                ...
                                <div>
                                    ...
                                    <select name="parent_id"
                                        ...
                                        @foreach ($parents as $parentId => $parentLabel)
                                            <option value="{{ $parentId }}" @selected(old('parent_id') == $parentId)>
                                                {{ $parentLabel }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="flex items-end pb-1">
                                    <label class="inline-flex items-center gap-3 cursor-pointer">
                                        ...
                                        <input type="checkbox" name="show_in_sidebar" value="1"
                                            @checked(old('show_in_sidebar', true))
                        ...
                        <div class="p-6 space-y-7">
                            ...
                            <div>
                                ...
                                <img id="preview-image"
                                    class="mt-3 hidden h-12 w-12 rounded-xl object-cover border border-slate-200 shadow-sm"
                                    alt="Preview"> <!-- ربع الحجم -->
                            </div>
                            ...
                            <div>
                                ...
                                <img id="preview-banner"
                                    class="mt-3 hidden h-12 w-20 rounded-xl object-cover border border-slate-200 shadow-sm"
                                    alt="Preview"> <!-- ربع الحجم -->
                            </div>
