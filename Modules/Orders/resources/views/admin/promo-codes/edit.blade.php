...
<div class="space-y-6">
    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
            <h1 class="text-2xl font-bold text-brand-navy">{{ __('Edit Promo Code') }}</h1>
            <p class="mt-1 text-sm text-brand-navy/60">{{ __('Update promo code details') }}</p>
        </div>
            ...
            <div class="grid gap-6 lg:grid-cols-2">
                ...
                <div>
                    ...
                    <input
                        ...
                        id="min_amount"
                        name="min_amount"
                        value="{{ old('min_amount', $promoCode->min_amount) }}"
                        min="0"
                        step="0.01"
