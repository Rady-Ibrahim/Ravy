                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        ...
                        <div>
                            ...
                            @if ($size->image)
                                <div class="mt-2">
                                    <img src="{{ asset('storage/' . $size->image) }}" alt="{{ $size->name }}" class="h-20 w-20 rounded-lg object-cover">
                        ...
                        <div>
                            ...
                            <input type="number" id="sort_order" name="sort_order" value="{{ old('sort_order', $size->sort_order) }}" min="0"
                                   class="mt-1 block w-full rounded-lg border border-slate-300 px-3 py-2 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
                            @error('sort_order')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
